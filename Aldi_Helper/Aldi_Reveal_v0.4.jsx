(function createUI(thisObj) {
    var panel = (thisObj instanceof Panel) ? thisObj : new Window("palette", "Highlight Reveal", undefined);
    panel.orientation = "column";
    
    var revealButton = panel.add("button", undefined, "Highlight-Reveal");
    revealButton.size = [120, 30];
    
    revealButton.onClick = function() {
        app.beginUndoGroup("Highlight Reveal Animation");
        try {
